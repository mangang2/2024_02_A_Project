...
public class ItemDetector : MonoBehaviour
{
    ...
    public CollectibleItem currentNearbyItem;         //가장 가까지 있는 수집 가능한 아이템
    
    // Start is called before the first frame update
    void Start()
    {
        lastPostion = transform.position;          //시작시 현재 위치를 마지막 위치로 설정
    ...
    private void OnDrawGizmos()      //유티니 Scene창에 보이는 Debug 그림
    {
